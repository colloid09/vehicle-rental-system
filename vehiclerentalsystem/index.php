                        ...
                        <div class="display-table">
                            <div class="display-table-cell">
                                <div class="slider-right-text">
                                    ...
                                    <p>ONE OF OUR BEST HACTHBACKS FOR AS LOW AS ₹800 A DAY <br> FLAT 15% DISCOUNT APPLICABLE TO RETURNING CUSTOMERS</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        ...
                        <span class="title-line"><i class="fa fa-car"></i></span>
                        <p>Explore Our Top Deals From Top Rated Dealers</p>
                    </div>
                </div>
                <!-- Section Title End -->
            </div>
...
<li>Fuel:<?php echo $row['Fuel'];?></li>
                                                ...
                                                <a href="single-car-details.php?viewid=<?php echo $row['ID'];?>" class="rent-btn">Book</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-6 tata audi">
                                            <div class="single-new-car">
                                                ...
                                                <div class="p-car-content">
                                                    ...
                                                    <div class="p-car-feature">
                                                       <a href="single-twowheeler-details.php?viewid=<?php echo $row['ID'];?>" class="rent-btn">Book</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
